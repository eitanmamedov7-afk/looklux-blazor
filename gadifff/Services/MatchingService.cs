...
namespace gadifff.Services
{
    ...
    // and persists selected suggestions as saved outfits.
...
""";
        ...
        // Generates valid shirt/pants/shoes combinations while respecting user-selected seed items.
        ...
        // Sends combinations + user request to Gemini and parses structured scoring response.
        ...
        // Extracts intent tokens (style/color/occasion hints) from free-text request
        // so deterministic fallback scoring can still align with the user's prompt.
